...
export default function ActivityCreate() {
  ...
  useEffect(() => {
    // Como siempre, un hook que es llamado, cuando el componente ya es montado
  ...
  function validate(input) {
    ...
    if (input.name.length < 3 || input.name.length > 15)
      errors.name = "*Nombre de Actividad invalido*";
    setButtonEnabled(false);
    if (input.duration <= 0 || input.duration >= 24)
      errors.duration = "*Por favor, escriba una duracion entre 1 a 24 horas*";
    setButtonEnabled(false);
    ...
    setButtonEnabled(false);
    if (!input.NombrePais)
      errors.NombrePais = "*Por favor, seleccione un pais*";
    setButtonEnabled(false);
    if (!input.dificulty)
      errors.dificulty = "*Por favor, seleccione una dificultad*";
    setButtonEnabled(false);
    ///////////////////////////////////////////////////////////////////////////////////
